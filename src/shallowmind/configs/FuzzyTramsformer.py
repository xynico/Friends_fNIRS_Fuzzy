...
# work_dir='/projects/CIBCIGroup/00DataUploading/Liang/fuzzy_fnirs/Friends_fNIRS_Fuzzy/work_dir_rule'
...
exp_name=f"FTF-ds={dataset_name}_{dataset_para['type'][-1]}-d={model_para['depth']}-nh={model_para['num_heads']}-r={model_para['num_rules']}-bs={batch_size}-ls={base_lr}-label={dataset_para['label']}-drs={dataset_para['dataset_random_state']}"
