...
from .scheduler import Constant, Step, MultiStep, Linear, CosineAnnealing, OneCycle, WarmupCosineDecayLR
...
__all__ = ['SGD', 'Adam', 'AdamW', 'RMSprop', 'Bert',
           ...
           'Constant', 'Step', 'MultiStep', 'Linear', 'CosineAnnealing', 'OneCycle', 'WarmupCosineDecayLR']